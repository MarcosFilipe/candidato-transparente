...
import { User, ChevronRight, Coins, Package, Building } from 'lucide-react';
...
export function CandidateTable({ data, onSelectCandidate }: CandidateTableProps) {
  ...
  return (
    <div className="border border-border rounded-lg overflow-hidden bg-card">
      {/* Header */}
      <div className="grid grid-cols-12 gap-2 px-4 py-3 bg-table-header border-b border-border text-xs font-semibold text-muted-foreground uppercase tracking-wide">
            ...
            return (
              ...
              >
                <button
                  ...
                  className="w-full h-full grid grid-cols-12 gap-2 px-4 py-2 items-center text-left hover:bg-table-hover transition-colors border-b border-border/50 group"
                >
                  {/* Candidate info */}
                  ...
                  <div className="col-span-2 flex items-center justify-end gap-2">
                    <div className="text-right">
                      {hasAssets ? (
                        ...
                        <span className="text-sm italic text-value-zero">
                          Sem bens declarados
                        </span>
                      )}
                    </div>
